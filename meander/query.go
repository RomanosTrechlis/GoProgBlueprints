...
// APIKey holds google's API key
var APIKey string

// Place defines the structures needed on order to parse
// the JSON response from google places API into usable objects.
type Place struct {
...
// Public maps google response structure to our API exported structure.
